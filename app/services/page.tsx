...
import { Crown, Scissors, Sparkles, ScrollText } from "lucide-react";
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-6 relative">
                  ...
                  {/* Icon with Shine */}
                  <div
                    className="icon-shine w-16 h-16 rounded-full flex items-center justify-center
                    bg-gradient-to-br from-[#d7b873] to-[#b48a41]
                    shadow-[inset_0_1px_4px_rgba(255,255,255,0.6),0_4px_18px_rgba(0,0,0,0.15)]
                    transition-transform group-hover:scale-105"
                  >
                    <Icon className="text-white" size={32} strokeWidth={1.4} />
                  </div>
